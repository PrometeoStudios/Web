...
function ROICalculator() {
  ...
  const calculateROI = () => {
    ...
    const reducedCancellations = ((formData.currentAppointments * formData.cancellationRate) / 100) * 0.7 // 70% menos cancelaciones
    const totalNewAppointments = additionalAppointments + reducedCancellations
    const additionalRevenue = totalNewAppointments * formData.averageServiceValue
    ...
    const investment = 2400 // Costo anual promedio del servicio
    ...
    if (typeof document !== "undefined") {
      ...
      if (timeSavingsEl) timeSavingsEl.textContent = `${Math.round(weeklyTimeSaved)}h/semana`
      if (monthlySavingsEl) monthlySavingsEl.textContent = `€${Math.round(monthlyCostSavings).toLocaleString()}`
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div>
        <label className="block text-sm font-medium text-gray-300 mb-2">Costo por hora de empleado (€)</label>
        <Input
          type="number"
      ...
      <div>
        <label className="block text-sm font-medium text-gray-300 mb-2">Horas semanales en tareas manuales</label>
        <Input
          type="number"
          value={formData.hoursPerWeek}
          onChange={(e) => handleInputChange("hoursPerWeek", Number.parseInt(e.target.value) || 0)}
          className="bg-[#1a1a1a] border-[#808080] text-white h-12 text-base"
          min="5"
          max="80"
        />
      ...
      <div>
        <label className="block text-sm font-medium text-gray-300 mb-2">Citas/consultas mensuales actuales</label>
        <Input
          type="number"
          value={formData.currentAppointments}
          onChange={(e) => handleInputChange("currentAppointments", Number.parseInt(e.target.value) || 0)}
          className="bg-[#1a1a1a] border-[#808080] text-white h-12 text-base"
          min="10"
          max="1000"
        />
      ...
      <div>
        <label className="block text-sm font-medium text-gray-300 mb-2">Tasa de cancelación actual (%)</label>
        <Input
          type="number"
          value={formData.cancellationRate}
          onChange={(e) => handleInputChange("cancellationRate", Number.parseInt(e.target.value) || 0)}
          className="bg-[#1a1a1a] border-[#808080] text-white h-12 text-base"
          min="0"
          max="100"
        />
      ...
      <div>
        <label className="block text-sm font-medium text-gray-300 mb-2">Valor promedio por servicio (€)</label>
        <Input
          type="number"
          value={formData.averageServiceValue}
          onChange={(e) => handleInputChange("averageServiceValue", Number.parseInt(e.target.value) || 0)}
          className="bg-[#1a1a1a] border-[#808080] text-white h-12 text-base"
          min="20"
          max="500"
        />
...
export default function PrometeoStudiosLanding() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await fetch("https://n8n.prometeostudios.com/webhook/980897ac-be55-48bb-b0c0-74b9216c2b5c", {
        method: "POST",
        headers: {
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#1a1a1a] to-[#2d2d2d] text-white">
      ...
      >
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          >
            <Button
              onClick={() => window.open("https://cal.com/prometeo-studios/consulta", "_blank")}
        ...
        <div className="container mx-auto text-center">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            ...
            >
              ...
              >
                Cómo <span className="text-[#c0c0c0] font-bold">47 clínicas e inmobiliarias</span> están llenando su
              ...
              >
                Automatizar atención, citas y ventas sin cambiar tu software. Sistema probado que funciona 24/7 mientras
                duermes.
              </motion.p>
            ...
            >
              <div className="relative">
                <motion.div
                  ...
                  className="w-80 h-80 rounded-full bg-gradient-to-br from-[#2d2d2d] to-[#1a1a1a] border-4 border-[#808080] flex items-center justify-center"
                >
                  <Image
                    src="/placeholder.svg?height=300&width=300"
                    alt="Fundador Prometeo Studios"
                    width={300}
                    height={300}
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <motion.div variants={scaleIn}>
              <div className="text-4xl lg:text-5xl font-black text-[#c0c0c0] mb-2">47+</div>
              <div className="text-gray-400">Empresas Automatizadas</div>
            </motion.div>
            <motion.div variants={scaleIn}>
              <div className="text-4xl lg:text-5xl font-black text-[#c0c0c0] mb-2">150%</div>
              <div className="text-gray-400">Más Citas Promedio</div>
            </motion.div>
            <motion.div variants={scaleIn}>
              <div className="text-4xl lg:text-5xl font-black text-[#c0c0c0] mb-2">25h</div>
              <div className="text-gray-400">Ahorradas por Semana</div>
            </motion.div>
            <motion.div variants={scaleIn}>
              <div className="text-4xl lg:text-5xl font-black text-[#c0c0c0] mb-2">24/7</div>
        ...
        <div className="container mx-auto">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-black mb-6">
              AUTOMATIZACIÓN QUE <span className="text-[#c0c0c0]">FUNCIONA</span>
            </h2>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              No más tiempo perdido en tareas repetitivas. Nuestro sistema trabaja mientras tú te enfocas en crecer.
            </p>
          </motion.div>
              ...
              <Card className="bg-[#2d2d2d] border-[#808080] hover:border-[#c0c0c0] transition-all duration-300 hover:shadow-2xl hover:shadow-[#c0c0c0]/20 h-full">
                <CardContent className="p-8">
                  ...
                  <p className="text-gray-400 mb-6">
                    Atiende clientes 24/7, responde preguntas frecuentes y agenda citas automáticamente.
                  </p>
            ...
            <motion.div variants={fadeInUp}>
              <Card className="bg-[#2d2d2d] border-[#808080] hover:border-[#c0c0c0] transition-all duration-300 hover:shadow-2xl hover:shadow-[#c0c0c0]/20 h-full">
                <CardContent className="p-8">
                  ...
                  <h3 className="text-2xl font-bold mb-4">Agente Telefónico con Voz IA</h3>
                  <p className="text-gray-400 mb-4">Responde llamadas como una secretaria virtual.</p>
                  <p className="text-gray-400 mb-6">
                    Gestiona citas, resuelve dudas frecuentes y mejora la atención al cliente.
                  </p>
                  <div className="text-[#c0c0c0] font-bold flex items-center gap-2">
                    <CheckCircle className="h-5 w-5 text-green-500" />
            ...
            <motion.div variants={fadeInUp}>
              <Card className="bg-[#2d2d2d] border-[#808080] hover:border-[#c0c0c0] transition-all duration-300 hover:shadow-2xl hover:shadow-[#c0c0c0]/20 h-full">
                <CardContent className="p-8">
                  ...
                  <p className="text-gray-400 mb-6">
                    Sistema inteligente que optimiza tu agenda y reduce cancelaciones.
                  </p>
                  <div className="text-[#c0c0c0] font-bold flex items-center gap-2">
                    <CheckCircle className="h-5 w-5 text-green-500" />
            ...
            <motion.div variants={fadeInUp}>
              <Card className="bg-[#2d2d2d] border-[#808080] hover:border-[#c0c0c0] transition-all duration-300 hover:shadow-2xl hover:shadow-[#c0c0c0]/20 h-full">
                <CardContent className="p-8">
                  ...
                  <h3 className="text-2xl font-bold mb-4">Seguimiento Post-Cita Inteligente</h3>
                  <p className="text-gray-400 mb-4">Contacta automáticamente con los pacientes tras cada visita.</p>
                  <p className="text-gray-400 mb-6">
                    Solicita reseñas, recaptura pacientes inactivos y mejora la relación.
                  </p>
                  <div className="text-[#c0c0c0] font-bold flex items-center gap-2">
                    <CheckCircle className="h-5 w-5 text-green-500" />
            ...
            <motion.div variants={fadeInUp}>
              <Card className="bg-[#2d2d2d] border-[#808080] hover:border-[#c0c0c0] transition-all duration-300 hover:shadow-2xl hover:shadow-[#c0c0c0]/20 h-full">
                <CardContent className="p-8">
                  ...
                  <p className="text-gray-400 mb-6">
                    Identifica automáticamente los mejores prospectos para maximizar conversiones.
                  </p>
                  <div className="text-[#c0c0c0] font-bold flex items-center gap-2">
                    <CheckCircle className="h-5 w-5 text-green-500" />
            ...
            <motion.div variants={fadeInUp}>
              <Card className="bg-[#2d2d2d] border-[#808080] hover:border-[#c0c0c0] transition-all duration-300 hover:shadow-2xl hover:shadow-[#c0c0c0]/20 h-full">
                <CardContent className="p-8">
                  ...
                  <h3 className="text-2xl font-bold mb-4">Mini CRM + Panel de Control</h3>
                  <p className="text-gray-400 mb-6">
                    Consulta KPIs en tiempo real, gestiona contactos y centraliza tu información.
                  </p>
                  <div className="text-[#c0c0c0] font-bold flex items-center gap-2">
                    <CheckCircle className="h-5 w-5 text-green-500" />
      ...
      >
        <div className="container mx-auto">
            ...
            >
              <Card className="bg-[#2d2d2d] border-[#808080]">
                <CardContent className="p-4 sm:p-8">
                  <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-[#c0c0c0]">Datos de tu Negocio</h3>
                  <ROICalculator />
                </CardContent>
              </Card>
            </motion.div>
            ...
            >
              <Card className="bg-gradient-to-br from-[#2d2d2d] to-[#1a1a1a] border-[#c0c0c0]">
                <CardContent className="p-6">
                  ...
                  <div id="time-savings" className="text-3xl font-black text-[#c0c0c0] mb-2">
                    25h/semana
                  </div>
                  <p className="text-gray-400">Tiempo liberado para actividades estratégicas</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gradient-to-br from-[#2d2d2d] to-[#1a1a1a] border-[#c0c0c0]">
                <CardContent className="p-6">
                  ...
                  <div id="monthly-savings" className="text-3xl font-black text-green-500 mb-2">
                    €2,500
                  </div>
                  <p className="text-gray-400">En costos operativos reducidos</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gradient-to-br from-[#2d2d2d] to-[#1a1a1a] border-[#c0c0c0]">
                <CardContent className="p-6">
                  ...
                  <div id="additional-revenue" className="text-3xl font-black text-blue-500 mb-2">
                    €4,200
                  </div>
                  <p className="text-gray-400">Por más citas y mejor conversión</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gradient-to-br from-green-900/20 to-green-800/20 border-green-500">
                <CardContent className="p-6">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h4 className="text-xl font-bold text-green-400">ROI Total Anual</h4>
                  </div>
                  <div id="total-roi" className="text-4xl font-black text-green-400 mb-2">
                    +580%
                  </div>
                  <p className="text-green-200">Retorno sobre la inversión en 12 meses</p>
                </CardContent>
              </Card>
            </motion.div>
          </div>
          ...
          >
            <p className="text-gray-400 mb-6">*Cálculos basados en promedios de nuestros clientes actuales</p>
            <Button
              size="lg"
              onClick={() => window.open("https://cal.com/prometeo-studios/consulta", "_blank")}
      ...
      >
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-400">Resultados verificables de nuestros clientes en los últimos 90 días</p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-16">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <h3 className="text-3xl font-bold text-[#c0c0c0] mb-8 text-center">CLÍNICAS</h3>
              <motion.div
                variants={staggerContainer}
                initial="initial"
                whileInView="animate"
                  ...
                  <Card className="bg-gradient-to-r from-[#2d2d2d] to-[#1a1a1a] border-[#c0c0c0]">
                    <CardContent className="p-6">
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                          <h4 className="text-xl font-bold">Clínica Dental Lamela</h4>
                          <p className="text-gray-400">Santiago de Compostela, España</p>
                        </div>
                      </div>
                      <div className="text-4xl font-black text-[#c0c0c0] mb-2">+1000</div>
                      <p className="text-lg font-semibold mb-2">Citas gestionadas automáticamente en 30 días</p>
                      <p className="text-gray-400">Sistema de recordatorios automatizado vía Whatsapp</p>
                    </CardContent>
                  </Card>
                </motion.div>
                  ...
                  <Card className="bg-gradient-to-r from-[#2d2d2d] to-[#1a1a1a] border-[#c0c0c0]">
                    <CardContent className="p-6">
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                          <h4 className="text-xl font-bold">Centro Médico Geli</h4>
                          <p className="text-gray-400">Barcelona, España</p>
                        </div>
                      </div>
                      <div className="text-4xl font-black text-[#c0c0c0] mb-2">25h</div>
                      <p className="text-lg font-semibold mb-2">Ahorradas por semana en gestión</p>
                      <p className="text-gray-400">Tiempo reinvertido en atención al paciente</p>
                    </CardContent>
                  </Card>
                </motion.div>
              </motion.div>
            ...
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <h3 className="text-3xl font-bold text-[#c0c0c0] mb-8 text-center">INMOBILIARIAS</h3>
              <motion.div
                variants={staggerContainer}
                initial="initial"
                whileInView="animate"
                ...
                <motion.div variants={fadeInUp}>
                  <Card className="bg-gradient-to-r from-[#2d2d2d] to-[#1a1a1a] border-[#c0c0c0]">
                    <CardContent className="p-6">
                      ...
                      <div className="text-4xl font-black text-[#c0c0c0] mb-2">+200%</div>
                      <p className="text-lg font-semibold mb-2">Leads calificados mensuales</p>
                      <p className="text-gray-400">De 50 a 150 leads de alta calidad por mes</p>
                    </CardContent>
                  </Card>
                </motion.div>
                  ...
                  <Card className="bg-gradient-to-r from-[#2d2d2d] to-[#1a1a1a] border-[#c0c0c0]">
                    <CardContent className="p-6">
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                          <h4 className="text-xl font-bold">Grupo Inmobiliario Sur</h4>
                          <p className="text-gray-400">Sevilla, España</p>
                        </div>
                      </div>
                      <div className="text-4xl font-black text-[#c0c0c0] mb-2">+80%</div>
                      <p className="text-lg font-semibold mb-2">De llamadas gestionadas por nuestra IA</p>
                      <p className="text-gray-400">Ahorro de 20h semanales en atención al cliente y prospección</p>
                    </CardContent>
                  </Card>
                </motion.div>
              </motion.div>
      ...
      >
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-400">De la llamada a resultados en menos de 7 días</p>
          </motion.div>
          ...
          >
            <motion.div variants={scaleIn} className="text-center">
              ...
              <p className="text-gray-400">Revisamos tu negocio y identificamos oportunidades de automatización</p>
            </motion.div>
            ...
            <motion.div variants={scaleIn} className="text-center">
              ...
              <p className="text-gray-400">Implementamos el sistema personalizado para tu industria</p>
            </motion.div>
            ...
            <motion.div variants={scaleIn} className="text-center">
              ...
              <p className="text-gray-400">Optimizamos y ajustamos hasta lograr los resultados esperados</p>
            </motion.div>
            ...
            <motion.div variants={scaleIn} className="text-center">
              ...
              <p className="text-gray-400">Monitoreo continuo y mejoras para maximizar tu ROI</p>
            </motion.div>
          </motion.div>
        </div>
      </motion.section>
        ...
        <div className="container mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8">
              Únete a las 47 empresas que ya están generando más clientes con menos trabajo
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            >
              ...
              <p className="text-lg sm:text-xl text-gray-400 mb-6 sm:mb-8">
                Agenda una demo gratuita de 15 minutos y descubre cómo podemos automatizar tu negocio
              </p>
              ...
              <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                <div className="flex items-center gap-3 sm:gap-4 p-3 bg-[#2d2d2d] rounded-lg">
                  ...
                  <a href="tel:+34644556479" className="text-base sm:text-lg hover:text-[#c0c0c0] transition-colors">
                    +34 644 556 479
                  </a>
                </div>
                <div className="flex items-center gap-3 sm:gap-4 p-3 bg-[#2d2d2d] rounded-lg">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <Button
                  variant="outline"
                  onClick={() => window.open("https://www.linkedin.com/in/mario-fernández-974ba6373", "_blank")}
                ...
                <Button
                  variant="outline"
                  onClick={() => window.open("https://wa.me/34644556479", "_blank")}
                  className="border-[#808080] text-white hover:bg-[#2d2d2d] bg-transparent h-12 text-base font-medium"
                >
                  <svg className="mr-2 h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            >
              <Card className="bg-[#2d2d2d] border-[#808080]">
                <CardContent className="p-4 sm:p-8">
                  <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6">Demo Gratuita</h3>
                  <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-300 mb-1 sm:mb-2">Nombre completo *</label>
                      <Input
                        name="nombre"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-300 mb-1 sm:mb-2">Teléfono *</label>
                      <Input
                        type="tel"
                        name="telefono"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-300 mb-1 sm:mb-2">Empresa *</label>
                      <Input
                        name="empresa"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-300 mb-1 sm:mb-2">Tipo de negocio *</label>
                      <select
                        name="tipoNegocio"
                        className="w-full h-12 p-3 bg-[#1a1a1a] border border-[#808080] rounded-md text-white text-base focus:ring-2 focus:ring-[#c0c0c0] focus:border-[#c0c0c0]"
                        required
      ...
      >
        <div className="container mx-auto text-center">
          <div className="text-2xl font-bold text-[#c0c0c0] mb-4">PROMETEO STUDIOS</div>
          <p className="text-gray-400 mb-4">Automatización inteligente para empresas que quieren crecer</p>
          ...
          <p className="text-xs text-gray-500 mt-4">
            © {new Date().getFullYear()} Prometeo Studios. Todos los derechos reservados.
          </p>
        </div>
      </motion.footer>
    </div>
